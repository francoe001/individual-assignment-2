...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 20 23:41:00 2018
...
class Student:
     ...
     def __init__(self, name, last_name, age, masters):
         self.name = name
...
class Master:
    ...
    def add_master_students_list(self, master_students_list):
        self.master_students = self.master_students + master_students_list
        
    def print_student(self):
        for student in self.master_students:      
            print(student.name + " " + student.last_name + " is a "+ student.age + " years old student of the " + student.masters + " masters program")      
